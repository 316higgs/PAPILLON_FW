...
//////////////////////////////////////
// PAPILLON FW ver. 2023.03.14
// -Allocated memory adreess for width threshold
//
//////////////////////////////////////
`define SYN_DATE	32'h2023_0315
...
//-------- Input/Output -------------
	...
	(* mark_debug = "true" *) output  [15:0]  REG_NOMINAL_WIDTH;
...
//	reg		[7:0]	x1D_Reg			;
	...
	reg		[7:0]	x3E_Reg			;//Interlock reset/Interlock test
	reg		[7:0]	x3F_Reg			;
	...
	reg		[7:0]	x70_Reg			;//trigger tag mode
...
//				x1D_Reg[7:0]	<= (regCs[1] & (irAddr[3:0]==4'hD) ? irWd[7:0] : x1D_Reg[7:0]);
				...
				x3E_Reg[7:0]	<= (regCs[3] & (irAddr[3:0]==4'hE) ? irWd[7:0] : x3E_Reg[7:0]);//Interlock reset/Interlock test                  
				...
				x70_Reg[7:0]	<= (regCs[7] & (irAddr[3:0]==4'h0) ? irWd[7:0] : x70_Reg[7:0]);//trigger tag mode                                  
				...
				x7F_Reg[7:0]	<= (regCs[7] & (irAddr[3:0]==4'hF) ? irWd[7:0] : x7F_Reg[7:0]);//offset                                            
...
//		REG_DELAY[15:0]	<= {REG_LEN[15:0]} + {x08_Reg[7:0],x09_Reg[7:0]};
	...
	assign  REG_NOMINAL_WIDTH[8*2-1:8*1]   = x23_Reg[7:0];
	assign  REG_NOMINAL_WIDTH[8*1-1:8*0]   = x24_Reg[7:0];
	...
	assign	REG_OFFSET  [15:8]  =   x3E_Reg[7:0];//Interlock reset/Interlock test                   
	...
	assign REG_INTERLOCK[1:0]	    = x70_Reg[7:0];  
