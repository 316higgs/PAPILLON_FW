...
#
# Generated by export_simulation on Mon Nov 22 23:13:37 +0900 2021
#
################################################################################
...
'-reset_run' switch to the './SYSCLK0.sh' script.

./SYSCLK0.sh -reset_run
...
./SYSCLK0.sh -noclean_files

For more information on the script, please type './SYSCLK0.sh -help'.
