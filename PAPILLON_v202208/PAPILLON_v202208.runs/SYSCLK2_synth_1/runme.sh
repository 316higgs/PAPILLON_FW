...
HD_PWD='C:/Users/kensh/Desktop/FPGA/PAPILLON/PAPILLON_v3s/PAPILLON_v3s.runs/SYSCLK2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SYSCLK2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SYSCLK2.tcl
