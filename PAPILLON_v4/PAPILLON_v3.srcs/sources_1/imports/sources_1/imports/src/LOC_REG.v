...
//				x1D_Reg[7:0]	<= (regCs[1] & (irAddr[3:0]==4'hD) ? irWd[7:0] : x1D_Reg[7:0]);
				...
				x75_Reg[7:0]	<= 8'd0;//ADC1~3 interface fco delay [4:0]                   
...
//			4'hD:	rdDataB[7:0]	<= x1D_Reg[7:0];
		...
		endcase
		case(irAddr[3:0])
			4'h0:	rdDataC[7:0]	<= x20_Reg[7:0]; //ADC pedestal 0ch~7ch   
		...
		case(irAddr[3:0])
			...
			4'h5:	rdDataH[7:0]	<= 8'd0;//ADC1~3 interface fco delay [4:0]             
...
//    assign adc3_if_reset            = x71_Reg[1];      
	...
	assign tap_fco_1[4:0]          	= 5'd0; 
    assign tap_fco_2[4:0]          	= 5'd0; 
    assign tap_fco_3[4:0]          	= 5'd0;
