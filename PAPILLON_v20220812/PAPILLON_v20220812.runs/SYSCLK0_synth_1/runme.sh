...
HD_PWD='C:/Users/kensh/Desktop/FPGA/PAPILLON/PAPILLON_v3s/PAPILLON_v3s.runs/SYSCLK0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SYSCLK0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SYSCLK0.tcl
