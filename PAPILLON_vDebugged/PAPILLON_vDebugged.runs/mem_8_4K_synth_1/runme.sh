...
HD_PWD='C:/Users/kensh/Desktop/FPGA/PAPILLON/PAPILLON_v3s/PAPILLON_v3s.runs/mem_8_4K_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mem_8_4K.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mem_8_4K.tcl
